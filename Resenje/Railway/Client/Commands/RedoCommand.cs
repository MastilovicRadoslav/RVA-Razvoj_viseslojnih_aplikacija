...
// Komanda za ponavljanje prethodne akcije
namespace Client.Commands
{
	public class RedoCommand : ICommand
	{
		...
		{
			// Vraća rezultat provjere mogućnosti ponavljanja prethodne akcije
			return reciever.CanRedo();
		}

		// Metoda koja izvršava komandu ponavljanja prethodne akcije
		public void Execute(object parameter)
		{
			// Poziva metodu za ponavljanje prethodne akcije
			reciever.Redo();
		}
	}
}
